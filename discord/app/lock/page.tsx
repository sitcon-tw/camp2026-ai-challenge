...
export default function LockPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      setError("Lock terminal unreachable. Try again.");
    } finally {
      setSubmitting(false);
    }
  }
          ...
          <div className="px-6 py-7">
            {status === "unlocked" ? (
              <div className="space-y-5 text-center animate-fade-in-up">
                ...
                <h1 className="text-2xl font-bold text-[#57f287]">Door released</h1>
                <p className="text-sm text-[#7da890]">
                  Recovery accepted. The Safehouse-04 door slides open.
                  <br />
                  <span className="text-[#9fe6b4]">Yoru is safe.</span> Mission complete.
                </p>
                {flag && (
              ...
              <>
                ...
                <p className="mt-1 mb-6 text-xs leading-relaxed text-[#6f9a82]">
                  The remote lock is sealed. Provide the three Safehouse-04
                  recovery answers to release the door.
                </p>
                ...
                >
                  {submitting ? "Verifying..." : "UNLOCK DOOR"}
                </button>
              </>
            )}
          </div>
