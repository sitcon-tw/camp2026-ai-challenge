...
export const LOCK_QUESTIONS: LockQuestion[] = [
  { id: "q1", label: "Recovery 1 — Tidal access word", hint: "the safehouse's tidal cipher word" },
  { id: "q2", label: "Recovery 2 — Mooring point", hint: "where the safehouse boat is docked" },
  { id: "q3", label: "Recovery 3 — Lock reset code", hint: "the four-digit reset code" },
];
